                            ...
                            <ItemTemplate>
                                <tr>
                                    <td>
                                        ...
                                        &nbsp;
                            <asp:LinkButton ID="lbDelete" runat="server" CommandArgument='<%#Eval("Id") %>' OnClientClick="return confirm('確認是否刪除？')" OnClick="lbDelete_Click" CssClass="btn btn-danger">删除</asp:LinkButton>&nbsp
                        ...
                        <table class="table">
                            <tr>
                                <td class="bg-primary">
                                    <label>帳號</label></td>
                                <td>
                                    <asp:TextBox ID="txtAccount" runat="server" autocomplete="off" CssClass="input-sm"></asp:TextBox></td>
                                <td class="bg-primary">
                                    <label>密碼</label></td>
                                <td>
                                    <asp:TextBox ID="txtPassword" runat="server" autocomplete="off" CssClass="input-sm"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td class="bg-primary">
                                    <label>姓名</label></td>
                                <td>
                                    <asp:TextBox ID="txtUserName" runat="server" autocomplete="off" CssClass="input-sm"></asp:TextBox></td>
                                <td class="bg-primary">
                                    <label>角色權限</label></td>
                                <td>
                                    <asp:DropDownList ID="ddlRole" runat="server" CssClass="input-sm"></asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <td class="bg-primary">
                                    <label>職稱</label></td>
                                <td>
                                    <asp:TextBox ID="txtURoleName" runat="server" autocomplete="off" CssClass="input-sm"></asp:TextBox></td>
                                <td class="bg-primary">
                                    <label>停用</label></td>
                                <td>
                            ...
                            <tr>
                                <td class="bg-primary">
                                    <label>建立人</label></td>
                                <td>
                                    <asp:Literal ID="ltCreateName" runat="server"></asp:Literal></td>
                                <td class="bg-primary">
                                    <label>建立日期</label></td>
                                <td>
                                    <asp:Literal ID="ltCreateDate" runat="server"></asp:Literal></td>
                            </tr>
                            <tr>
                                <td class="bg-primary">
                                    <label>更新日期</label></td>
                                <td>
                                    <asp:Literal ID="ltUpdateDate" runat="server"></asp:Literal></td>
                                <td class="bg-primary">
                                    <label>更新人</label></td>
                                <td>
                                    <asp:Literal ID="ltUpdateName" runat="server"></asp:Literal></td>
                            </tr>
                            <tr>
